...
# this sets a default argument, it is also set in the program but this just illustrates how to use cmd and override it from the terminal
CMD ["--url","https://github.com/lovkyasushya"]
